...
- Login tenant: `login.html` (+ `login.js`) — autentikasi Google atau username/email tanpa input workspace, deteksi tenant otomatis, dan handoff SSO langsung ke aplikasi
