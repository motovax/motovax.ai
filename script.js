  ...
  suites: [
    ...
    },
    {
      ...
      features: [
        ...
        { title: "Omni analytic", desc: "Pantau perjalanan lead dan performa tim", icon: "report", slug: "omni-jasmine-ai" },
        { title: "Custom aksi cepat", desc: "Cek stok dan simulasi kredit dari chat", icon: "workflow", slug: "omni-jasmine-ai" },
        { title: "3 funneling & 1 auto routing", desc: "AI, agent, dan MR ter-route otomatis", icon: "flow", slug: "omni-jasmine-ai" },
        { title: "AI 500 credit", desc: "Kredit AI untuk respons pelanggan", icon: "ai", slug: "omni-jasmine-ai" },
      ],
    },
    {
      id: "inventory-falcon",
      ...
      features: [
        ...
        { title: "Laporan dan aksi sesuai peran", desc: "Laporan stok dan aksi sesuai permission", icon: "report", slug: "inventory-falcon-ai" },
        { title: "Item / listing multi cabang", desc: "Stok seluruh cabang dalam satu sumber data", icon: "shop", slug: "inventory-falcon-ai" },
        { title: "Import listing via WhatsApp", desc: "Tambah listing langsung dari WhatsApp", icon: "wa", slug: "inventory-falcon-ai" },
        { title: "Live katalog API", desc: "Stok live dapat dipakai aplikasi eksternal", icon: "live", slug: "inventory-falcon-ai" },
        { title: "AI 500 credit", desc: "Kredit AI untuk bantuan pencarian unit", icon: "ai", slug: "inventory-falcon-ai" },
      ],
    },
    {
      id: "ana-analytics",
      ...
      features: [
        ...
        { title: "Analitik financial", desc: "Revenue, HPP, dan gross profit", icon: "deal", slug: "ana-ai-analytics" },
        { title: "Analitik sales performance", desc: "Bandingkan performa sales dan cabang", icon: "score", slug: "ana-ai-analytics" },
        { title: "Additional custom analytic", desc: "Analytics tambahan sesuai KPI Anda", icon: "workflow", slug: "ana-ai-analytics" },
      ],
    },
    {
      id: "social-sora",
      ...
      features: [
        ...
        { title: "Iris AI upscale & background edit", desc: "Perbaiki kualitas dan latar gambar dengan AI", icon: "ai", slug: "social-media-sora-ai" },
        { title: "Publish ke Facebook, Instagram & WhatsApp", desc: "Terbitkan ke kanal sosial dari satu alur", icon: "blast", slug: "social-media-sora-ai" },
        { title: "Scheduler", desc: "Jadwalkan konten sesuai kalender campaign", icon: "sla", slug: "social-media-sora-ai" },
        { title: "Meta ads manager", desc: "Kelola campaign Meta dan lead template WA", icon: "ads", slug: "social-media-sora-ai" },
        { title: "Meta ads analytic by Iris", desc: "Pantau performa iklan dengan insight AI", icon: "report", slug: "social-media-sora-ai" },
        { title: "AI 500 credit", desc: "Kredit AI untuk produksi konten", icon: "ai", slug: "social-media-sora-ai" },
      ],
    },
  ],
});
