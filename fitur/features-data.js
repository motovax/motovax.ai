...
window.MOTOVAX_FEATURES = {
  ...
  "omni-analytic": {
    ...
    heroTitle: "Pantau perjalanan lead dan performa tim dari satu dashboard",
    heroDesc:
      "Ukur hasil channel WhatsApp, Instagram, dan Facebook, kinerja response AI/agent, serta perjalanan lead dari AI ke Call Center hingga MR tanpa rekap manual.",
    status: "Live",
    module: "Jasmine AI + Omnichannel",
    flag: "whatsapp_ai",
    demo: "omni",
    demoHash: "omniDemo",
    category: "Aplikasi Omnichannel",
    breadcrumbs: ["Produk", "Modul", "Analytics Omnichannel"],
    capabilities: [
      { title: "Performa channel", desc: "Bandingkan hasil percakapan, respons, dan konversi per channel omnichannel." },
      { title: "Aktivitas agent dan AI", desc: "Lihat siapa yang menangani, waktu respons, dan hasil takeover/eskalasi." },
      { title: "Journey lead", desc: "Telusuri perjalanan customer dari percakapan hingga handoff MR dan pipeline." },
    ],
    howItWorks: [
      { title: "Channel masuk", desc: "Percakapan tercatat dari tiap channel dengan metadata tenant." },
      { title: "KPI dihitung", desc: "Metrik respons, faneling, dan hasil penanganan terakumulasi realtime." },
      { title: "Management membaca", desc: "Tim memantau channel mana yang berjalan dan di mana lead tersangkut." },
    ],
    benefits: ["Channel yang dipakai tidak membingungkan", "Kepemilikan dan hasil agent terukur", "Keputusan berbasis data live"],
    related: ["omni-jasmine-ai", "aplikasi-omnichannel", "personalisasi-report-sales", "aplikasi-crm"],
  },

  "custom-aksi-cepat": {
    slug: "custom-aksi-cepat",
    title: "Aksi Cepat di Chat",
    heroTitle: "Cek stok dan simulasi kredit tanpa meninggalkan percakapan",
    heroDesc:
      "Dari inbox omnichannel, agent menjalankan aksi cepat: cek inventori unit ready, hitung simulasi kredit, dan lanjutkan operasi dengan konteks pelanggan tetap utuh.",
    status: "Live",
    module: "Jasmine AI + Omnichannel",
    flag: "whatsapp_ai",
    demo: "omni",
    demoHash: "omniDemo",
    category: "Aplikasi Omnichannel",
    breadcrumbs: ["Produk", "Modul", "Aksi Cepat di Chat"],
    capabilities: [
      { title: "Cek inventori", desc: "Cari unit ready, harga, cabang, dan foto stok live dealer langsung dari percakapan." },
      { title: "Simulasi kredit", desc: "Hitung DP, tenor, dan angsuran dari aksi cepat, lalu bagikan hasilnya ke pelanggan." },
      { title: "Operasi lanjutan", desc: "Lanjutkan cek, catat lead, atau handoff tanpa memutus alur dari inbox." },
    ],
    howItWorks: [
      { title: "Buka aksi cepat", desc: "Agent memilih tool dari percakapan yang sedang ditangani." },
      { title: "Data live dipakai", desc: "Inventory dan kredit dibaca langsung dari data tenant." },
      { title: "Hasil di chat", desc: "Rincian unit atau simulasi dikirim ke customer dan tersimpan di konteks lead." },
    ],
    benefits: ["Konteks percakapan tidak terputus", "Stok dan kredit selalu dari data live", "Customer tak perlu menunggu pindah aplikasi"],
    related: ["omni-jasmine-ai", "inventory-falcon-ai", "aplikasi-omnichannel", "whatsapp-flows"],
  },

  "auto-routing-faneling": {
    slug: "auto-routing-faneling",
    title: "Funneling & Auto Routing",
    heroTitle: "AI, Agent, dan MR ter-route otomatis tanpa lead tercecer",
    heroDesc:
      "3 jalur faneling (AI → Call Center → MR) dengan 1 auto routing menjaga kepemilikan lead, membawa konteks percakapan, dan mencegah follow-up ganda.",
    status: "Live",
    module: "Jasmine AI + Omnichannel",
    flag: "whatsapp_ai",
    demo: "omni",
    demoHash: "omniDemo",
    category: "Aplikasi Omnichannel",
    breadcrumbs: ["Produk", "Modul", "Funneling & Auto Routing"],
    capabilities: [
      { title: "Jalur AI", desc: "Jasmine menangani respons awal dengan tool bisnis dan konteks tenant." },
      { title: "Takeover agent", desc: "Call Center mengambil alih tanpa kehilangan konteks percakapan." },
      { title: "Handoff ke MR", desc: "Lead di-routing ke Marketing Representative lengkap dengan alasan dan ringkasan." },
      { title: "Kepemilikan jelas", desc: "Bucket AI, Call Center, dan MR menampilkan status penanganan yang tegas." },
    ],
    howItWorks: [
      { title: "Pesan masuk", desc: "Lead masuk dan diarahkan ke bucket AI sesuai aturan tenant." },
      { title: "Eskalasi agent", desc: "Agent mengambil alih saat konteks atau kebutuhan pelanggan meningkat." },
      { title: "Handoff MR", desc: "MR menerima lead dengan riwayat lengkap untuk closing." },
    ],
    benefits: ["Lead tidak mengendap di satu bucket", "Konteks berpindah bersama lead", "Follow-up MR lebih fokus"],
    related: ["omni-jasmine-ai", "aplikasi-omnichannel", "aplikasi-crm", "manajemen-kontak"],
  },
  ...
  "falcon-ai-search": {
    slug: "falcon-ai-search",
    title: "Falcon AI — Pencarian & Rekomendasi",
    heroTitle: "Cari unit, kirim foto, dan dapatkan rekomendasi otomatis dari stok live",
    heroDesc:
      "Sales atau management menuliskan kebutuhan unit di percakapan. Falcon memahami permintaan, menjalankan tool inventory, lalu mengirim unit ready, foto, dan alternatif.",
    status: "Live",
    module: "Falcon AI + Inventory",
    flag: "inventory_management",
    demo: "falcon",
    demoHash: "falconDemo",
    category: "Inventory Management",
    breadcrumbs: ["Produk", "Modul", "Falcon AI — Pencarian"],
    capabilities: [
      { title: "Memahami permintaan stok", desc: "Model, tahun, cabang, kilometer, harga, atau status dibaca dari kalimat alami." },
      { title: "Kirim foto dan unit serupa", desc: "Unit ready lengkap dengan foto, plat, kilometer, cabang, dan harga." },
      { title: "Alternatif otomatis", desc: "Saat stok yang diminta tak ada, Falcon menawarkan unit serupa dari stok ready." },
    ],
    howItWorks: [
      { title: "Tulis kebutuhan", desc: "Sales/management mengetik permintaan unit di percakapan." },
      { title: "Falcon mencari", desc: "AI menjalankan query inventory tenant dan memilih unit ready." },
      { title: "Hasil di chat", desc: "Foto, detail, dan alternatif dikirim tanpa membuka tabel." },
    ],
    benefits: ["Cari stok lewat percakapan, bukan filter tabel", "Foto langsung dari unit ready", "Alternatif otomatis saat stok kosong"],
    related: ["inventory-falcon-ai", "inventory-multi-cabang", "aplikasi-crm", "agentic-ai"],
  },

  "inventory-laporan-peran": {
    slug: "inventory-laporan-peran",
    title: "Laporan & Aksi Sesuai Peran",
    heroTitle: "Sales dan management mendapat laporan stok yang sesuai permission",
    heroDesc:
      "Dari percakapan yang sama, sales mendapat pencarian, foto, simulasi, dan pencatatan lead, sedangkan management menerima laporan stok per cabang, aging, dan status perubahan.",
    status: "Live",
    module: "Falcon AI + Inventory",
    flag: "inventory_management",
    demo: "falcon",
    demoHash: "falconDemo",
    category: "Inventory Management",
    breadcrumbs: ["Produk", "Modul", "Laporan & Aksi Sesuai Peran"],
    capabilities: [
      { title: "Laporan management", desc: "Stok per cabang, aging unit, dan perubahan status dari konteks tenant." },
      { title: "Tool untuk sales", desc: "Pencarian, foto, simulasi, dan pencatatan lead dari stok live." },
      { title: "Aksi berbasis izin", desc: "Apa yang bisa dilihat dan dilakukan mengikuti role dan permission pengguna." },
    ],
    howItWorks: [
      { title: "Peran dikenali", desc: "Falcon membaca role dan permission pengguna." },
      { title: "Laporan disusun", desc: "Ringkasan sesuai kebutuhan sales atau management." },
      { title: "Dikirim di chat", desc: "Hasil sampai di percakapan tanpa pindah aplikasi." },
    ],
    benefits: ["Data sensitif terkendali per peran", "Sales dan management tak perlu tool terpisah", "Laporan lebih cepat dari stok live"],
    related: ["inventory-falcon-ai", "ana-ai-analytics", "core-platform-agentic-ai", "agentic-ai"],
  },

  "inventory-multi-cabang": {
    slug: "inventory-multi-cabang",
    title: "Listing Stok Multi-Cabang",
    heroTitle: "Stok seluruh cabang dalam satu sumber data yang dibaca AI",
    heroDesc:
      "Unit, status, pricing, foto, dokumen, dan lokasi cabang dikelola sebagai satu sumber kebenaran inventory yang dipakai Falcon dan tim lintas cabang.",
    status: "Live",
    module: "Falcon AI + Inventory",
    flag: "inventory_management",
    demo: "falcon",
    demoHash: "falconDemo",
    category: "Inventory Management",
    breadcrumbs: ["Produk", "Modul", "Listing Stok Multi-Cabang"],
    capabilities: [
      { title: "Unit ready, booked, sold", desc: "Status stok terlihat jelas per cabang dan keseluruhan." },
      { title: "Kelengkapan foto", desc: "Ketersediaan foto dan dokumen tampil sebagai bagian dari data unit." },
      { title: "Sumber untuk Falcon", desc: "Listing multi-cabang menjadi data yang dibaca AI saat mencari unit." },
    ],
    howItWorks: [
      { title: "Kelola listing", desc: "Tim mengisi unit, status, foto, dan lokasi cabang." },
      { title: "Satu sumber", desc: "Data lintas cabang disatukan dalam inventory tenant." },
      { title: "AI memakainya", desc: "Falcon mencari dan merekomendasikan dari listing yang akurat." },
    ],
    benefits: ["Stok antar-cabang tak tercecer", "Status unit lebih mudah diawasi", "Data yang dibaca AI selalu akurat"],
    related: ["inventory-falcon-ai", "falcon-ai-search", "inventory-live-katalog-api", "core-platform-agentic-ai"],
  },

  "inventory-import-wa": {
    slug: "inventory-import-wa",
    title: "Import Listing via WhatsApp",
    heroTitle: "Tambah listing stok langsung dari WhatsApp",
    heroDesc:
      "Import data unit lewat Excel atau Google Sheets — termasuk dari percakapan WhatsApp — dengan validasi dan deteksi konflik identitas sebelum masuk stok live.",
    status: "Live",
    module: "Falcon AI + Inventory",
    flag: "inventory_management",
    demo: "falcon",
    demoHash: "falconDemo",
    category: "Inventory Management",
    breadcrumbs: ["Produk", "Modul", "Import Listing via WhatsApp"],
    capabilities: [
      { title: "Import dari chat", desc: "Kirim data listing lewat WhatsApp dan nilai sebelum diproses." },
      { title: "Validasi & warning", desc: "Deteksi identitas bermasalah dan konflik sebelum data masuk." },
      { title: "Update stok live", desc: "Listing yang lolos langsung memperbarui stok yang dibaca tim dan AI." },
    ],
    howItWorks: [
      { title: "Kirim file/tabel", desc: "Data listing dikirim dari WhatsApp atau upload spreadsheet." },
      { title: "Validasi", desc: "Sistem menandai warning dan konflik identitas." },
      { title: "Masuk stok", desc: "Data valid aktif di listing dan siap dipakai Falcon." },
    ],
    benefits: ["Import tanpa keluar WhatsApp", "Data bersih sebelum masuk stok", "Stok live ter-update lebih cepat"],
    related: ["inventory-falcon-ai", "inventory-multi-cabang", "whatsapp-business-api", "aplikasi-omnichannel"],
  },

  "inventory-live-katalog-api": {
    slug: "inventory-live-katalog-api",
    title: "Live Katalog API",
    heroTitle: "Sajikan stok live ke aplikasi eksternal lewat endpoint katalog",
    heroDesc:
      "Endpoint katalog menyajikan stok aktif tenant ke aplikasi eksternal, menjaga data menjadi satu sumber kebenaran bagi AI dan integrasi lainnya.",
    status: "Live",
    module: "Falcon AI + Inventory",
    flag: "inventory_management",
    demo: "falcon",
    demoHash: "falconDemo",
    category: "Inventory Management",
    breadcrumbs: ["Produk", "Modul", "Live Katalog API"],
    capabilities: [
      { title: "Stok aktif via API", desc: "Listing ready dapat dibaca aplikasi eksternal melalui endpoint katalog." },
      { title: "Satu sumber", desc: "Data yang disajikan sama dengan yang dipakai AI dan tim di dalam app." },
      { title: "Terintegrasi operasional", desc: "Developer API memperluas penggunaan inventory ke ekosistem dealer." },
    ],
    howItWorks: [
      { title: "Data tenant", desc: "Listing stok aktif tersedia dari inventory tenant." },
      { title: "Endpoint katalog", desc: "Aplikasi eksternal mengambil stok lewat API." },
      { title: "Selalu sinkron", desc: "Perubahan status stok tercermin pada data yang disajikan." },
    ],
    benefits: ["Stok live untuk ekosistem eksternal", "Satu kebenaran data inventory", "Perluasan integrasi lebih mudah"],
    related: ["inventory-falcon-ai", "core-platform-agentic-ai", "whatsapp-business-api", "motovax-360"],
  },

  "ana-analitik-operasional": {
    slug: "ana-analitik-operasional",
    title: "Analitik Operasional",
    heroTitle: "Pantau stok, perputaran unit, omzet, dan konversi dalam satu layar",
    heroDesc:
      "KPI operasional dealer: stok lama, rata-rata hari jual, unit terjual, omzet, dan konversi lead ke booking — langsung dari data produksi.",
    status: "Live",
    module: "Ana AI — Advanced Analytics",
    category: "Analytics",
    demo: "dashboard",
    demoHash: "dashboardDemo",
    breadcrumbs: ["Produk", "Modul", "Analitik Operasional"],
    capabilities: [
      { title: "Stok dan perputaran", desc: "Pantau stok lama dan rata-rata hari jual unit." },
      { title: "Omzet dan unit terjual", desc: "Lihat hasil penjualan unit dan nilai omzet dalam periode terpilih." },
      { title: "Konversi lead ke booking", desc: "Ukur kualitas funnel dari lead masuk hingga booking." },
    ],
    howItWorks: [
      { title: "Data terhubung", desc: "Inventory dan sales mengisi metrik operasional." },
      { title: "Pilih periode", desc: "Dashboard menyesuaikan KPI per MTD, QTD, YTD, atau harian." },
      { title: "Baca dan rinci", desc: "Tim menelusuri hingga level unit, cabang, atau sales." },
    ],
    benefits: ["Stok dan perputaran lebih terlihat", "Keputusan operasional berbasis data live", "Konversi funnel terukur"],
    related: ["ana-ai-analytics", "inventory-falcon-ai", "personalisasi-report-sales", "motovax-360"],
  },

  "ana-analitik-financial": {
    slug: "ana-analitik-financial",
    title: "Analitik Finansial",
    heroTitle: "Revenue, HPP, gross profit, dan margin dalam satu dashboard",
    heroDesc:
      "Tampilkan revenue, HPP, gross profit, margin, tren laba, dan nilai stok per periode — untuk keputusan finansial dealer yang lebih cepat.",
    status: "Live",
    module: "Ana AI — Advanced Analytics",
    category: "Analytics",
    demo: "dashboard",
    demoHash: "dashboardDemo",
    breadcrumbs: ["Produk", "Modul", "Analitik Finansial"],
    capabilities: [
      { title: "Revenue dan HPP", desc: "Pendapatan dan harga pokok dalam satu tampilan." },
      { title: "Gross profit & margin", desc: "Laba kotor dan margin dihitung dari data sales." },
      { title: "Tren laba & nilai stok", desc: "Lihat tren profit dan nilai stok dalam periode terpilih." },
    ],
    howItWorks: [
      { title: "Transaksi mengalir", desc: "Data sales dan inventory menjadi sumber finansial." },
      { title: "Visualisasi", desc: "KPI finansial disajikan per periode dan cabang." },
      { title: "Keputusan", desc: "Management membaca profit dan margin untuk prioritas." },
    ],
    benefits: ["Profitabilitas lebih jelas", "Keputusan berbasis angka live", "Perbandingan margin lintas unit"],
    related: ["ana-ai-analytics", "motovax-360", "personalisasi-report-sales", "inventory-falcon-ai"],
  },

  "ana-analitik-sales": {
    slug: "ana-analitik-sales",
    title: "Analitik Sales Performance",
    heroTitle: "Bandingkan performa sales dan cabang dengan KPI yang terukur",
    heroDesc:
      "KPI pipeline, pendapatan, tingkat konversi, rata-rata deal, kecepatan closing, dan top agent tampil langsung dari halaman produksi.",
    status: "Live",
    module: "Ana AI — Advanced Analytics",
    category: "Analytics",
    demo: "dashboard",
    demoHash: "dashboardDemo",
    breadcrumbs: ["Produk", "Modul", "Analitik Sales Performance"],
    capabilities: [
      { title: "Pipeline & pendapatan", desc: "Nilai pipeline dan pendapatan dalam periode terpilih." },
      { title: "Konversi & kecepatan closing", desc: "Tingkat konversi dan waktu rata-rata menutup deal." },
      { title: "Perbandingan agent/cabang", desc: "Top agent dan bandingkan performa antar cabang." },
    ],
    howItWorks: [
      { title: "Data CRM masuk", desc: "Pipeline dan aktivitas sales mengisi metrik." },
      { title: "KPI disajikan", desc: "Dashboard menampilkan performa per peran." },
      { title: "Aksi diambil", desc: "Management fokus pada agent atau cabang di bawah target." },
    ],
    benefits: ["Productivitas sales terlihat", "Dasar penilaian lebih objektif", "Perbandingan lintas cabang"],
    related: ["ana-ai-analytics", "aplikasi-crm", "agent-scorecard", "manajemen-goal"],
  },

  "ana-custom-analytic": {
    slug: "ana-custom-analytic",
    title: "Custom Analytic",
    heroTitle: "Analytics tambahan sesuai KPI dan kebutuhan dealer Anda",
    heroDesc:
      "Lengkapi dashboard standar dengan analitik custom sesuai KPI dealer, sehingga tim melihat metrik yang benar-benar penting bagi bisnisnya.",
    status: "Live",
    module: "Ana AI — Advanced Analytics",
    category: "Analytics",
    demo: "dashboard",
    demoHash: "dashboardDemo",
    breadcrumbs: ["Produk", "Modul", "Custom Analytic"],
    capabilities: [
      { title: "KPI tambahan", desc: "Susun analitik di luar dashboard standar sesuai kebutuhan dealer." },
      { title: "Filter dan periode", desc: "Metrik dapat dilihat per cabang, peran, dan rentang waktu." },
      { title: "Terhubung data live", desc: "Custom analytic memakai sumber data operasional yang sama." },
    ],
    howItWorks: [
      { title: "Identifikasi KPI", desc: "Dealer menentukan metrik yang ingin dipantau." },
      { title: "Susun analytic", desc: "Tim menyiapkan tampilan sesuai kebutuhan." },
      { title: "Pantau rutin", desc: "KPI dipantau dan di-update dari data live." },
    ],
    benefits: ["Dashboard sesuai konteks dealer", "Metrik bisnis benar-benar terpantau", "Fleksibel menyesuaikan kebutuhan"],
    related: ["ana-ai-analytics", "ana-analitik-operasional", "personalisasi-report-sales", "motovax-360"],
  },

  "iris-content-studio": {
    slug: "iris-content-studio",
    title: "Content Studio",
    heroTitle: "Buat materi dan caption dari data inventori dealer",
    heroDesc:
      "Pilih unit ready sebagai sumber desain, harga, atribut, dan materi kampanye — lalu susun caption dan konten yang siap tayang.",
    status: "Live",
    module: "Iris AI + Social Media",
    flag: "social_media_automation",
    demo: "social",
    demoHash: "socialDemo",
    category: "Manajemen Campaign",
    breadcrumbs: ["Produk", "Modul", "Content Studio"],
    capabilities: [
      { title: "Sumber dari inventory", desc: "Unit dan foto stok jadi dasar desain dan materi." },
      { title: "Caption dan atribut", desc: "Harga, spesifikasi, dan caption disusun dari data unit." },
      { title: "Konsisten dengan stok", desc: "Materi selalu sinkron dengan kondisi stok tenant." },
    ],
    howItWorks: [
      { title: "Pilih unit", desc: "Content studio mengambil data dari inventory tenant." },
      { title: "Susun creative", desc: "Tim mengedit desain, visual, dan caption." },
      { title: "Siap tayang", desc: "Materi masuk ke scheduler atau langsung dipublikasikan." },
    ],
    benefits: ["Produksi konten lebih cepat", "Materi konsisten dengan stok", "Captions andal dari data live"],
    related: ["social-media-sora-ai", "iris-ai-edit", "inventory-falcon-ai", "motovax-broadcast"],
  },

  "iris-ai-edit": {
    slug: "iris-ai-edit",
    title: "AI Upscale & Background Edit",
    heroTitle: "Perbaiki kualitas dan latar gambar unit dengan AI",
    heroDesc:
      "Iris meningkatkan kualitas visual dan menyesuaikan background gambar kendaraan — dari stok dealer menjadi materi iklan yang lebih profesional.",
    status: "Live",
    module: "Iris AI + Social Media",
    flag: "social_media_automation",
    demo: "social",
    demoHash: "socialDemo",
    category: "Manajemen Campaign",
    breadcrumbs: ["Produk", "Modul", "AI Upscale & Background Edit"],
    capabilities: [
      { title: "Upscale kualitas", desc: "Tingkatkan resolusi dan ketajaman gambar unit." },
      { title: "Edit latar", desc: "Sesuaikan background agar tampak lebih profesional." },
      { title: "Variasi materi", desc: "Buat beberapa variasi visual dari satu unit untuk channel berbeda." },
    ],
    howItWorks: [
      { title: "Ambil foto unit", desc: "Foto dari stok atau unggahan jadi input." },
      { title: "Iris mengolah", desc: "AI memperbaiki kualitas dan latar." },
      { title: "Pakai untuk konten", desc: "Hasil keluar sebagai materi siap tayang." },
    ],
    benefits: ["Visual lebih profesional tanpa studio", "Materi beragam dari satu unit", "Kreatif lebih cepat rampung"],
    related: ["social-media-sora-ai", "iris-content-studio", "iris-publish", "aplikasi-broadcast-whatsapp"],
  },

  "iris-publish": {
    slug: "iris-publish",
    title: "Publish ke Facebook, Instagram & WhatsApp",
    heroTitle: "Terbitkan konten ke seluruh kanal dari satu alur",
    heroDesc:
      "Publikasikan feed, reel, story, dan materi WhatsApp melalui integrasi channel yang sudah terhubung — tanpa berpindah aplikasi.",
    status: "Live",
    module: "Iris AI + Social Media",
    flag: "social_media_automation",
    demo: "social",
    demoHash: "socialDemo",
    category: "Manajemen Campaign",
    breadcrumbs: ["Produk", "Modul", "Publish Multi-Channel"],
    capabilities: [
      { title: "Facebook & Instagram", desc: "Feed, reel, dan story dikirim lewat Meta Business." },
      { title: "WhatsApp", desc: "Materi promosi dipakai untuk posting dan campaign pelanggan." },
      { title: "Satu alur", desc: "Publish beberapa kanal dari satu proses kerja." },
    ],
    howItWorks: [
      { title: "Siapkan konten", desc: "Materi disiapkan di content studio." },
      { title: "Pilih kanal", desc: "Tim memilih Facebook, Instagram, atau WhatsApp." },
      { title: "Terbitkan", desc: "Konten dipublikasikan lewat integrasi channel aktif." },
    ],
    benefits: ["Konten sampai lebih luas", "Alur publish terpusat", "Hasil tampil di kanal yang dituju"],
    related: ["social-media-sora-ai", "iris-scheduler", "aplikasi-broadcast-whatsapp", "instagram-api"],
  },

  "iris-scheduler": {
    slug: "iris-scheduler",
    title: "Scheduler Konten",
    heroTitle: "Jadwalkan konten sesuai kalender campaign",
    heroDesc:
      "Susun jadwal publikasi feed, reel, story, dan materi lain dalam kalender tim agar campaign berjalan tertib dan tidak melewatkan momentum.",
    status: "Live",
    module: "Iris AI + Social Media",
    flag: "social_media_automation",
    demo: "social",
    demoHash: "socialDemo",
    category: "Manajemen Campaign",
    breadcrumbs: ["Produk", "Modul", "Scheduler Konten"],
    capabilities: [
      { title: "Kalender publikasi", desc: "Konten terjadwal tersusun dalam kalender tim." },
      { title: "Per platform", desc: "Jadwal dibedakan per platform dan jenis konten." },
      { title: "Konsisten campaign", desc: "Tim mengikuti kalender campaign yang terencana." },
    ],
    howItWorks: [
      { title: "Atur jadwal", desc: "Konten dijadwalkan di kalender." },
      { title: "Terbitkan otomatis", desc: "Publikasi berjalan sesuai slot waktu channel." },
      { title: "Pantau", desc: "Status dan performa konten terlihat terpusat." },
    ],
    benefits: ["Jadwal tim lebih teratur", "Konten tak tumpuk di hari sama", "Campaign konsisten dan terukur"],
    related: ["social-media-sora-ai", "iris-publish", "iris-meta-ads", "aplikasi-broadcast-whatsapp"],
  },

  "iris-meta-ads": {
    slug: "iris-meta-ads",
    title: "Meta Ads Manager",
    heroTitle: "Kelola campaign Meta dan lead template WhatsApp",
    heroDesc:
      "Atur ads campaign Meta lengkap dengan alur lead ke template WhatsApp, sehingga iklan yang menghasilkan lead langsung siap ditindaklanjuti.",
    status: "Live",
    module: "Iris AI + Social Media",
    flag: "social_media_automation",
    demo: "social",
    demoHash: "socialDemo",
    category: "Manajemen Campaign",
    breadcrumbs: ["Produk", "Modul", "Meta Ads Manager"],
    capabilities: [
      { title: "Kelola campaign", desc: "Susun dan pantau campaign Meta dari satu tempat." },
      { title: "Lead ke WhatsApp", desc: "Hasil iklan terhubung template WhatsApp untuk follow-up cepat." },
      { title: "Terintegrasi pipeline", desc: "Lead dari iklan masuk ke CRM dan pipeline yang ada." },
    ],
    howItWorks: [
      { title: "Buat campaign", desc: "Tim menyusun iklan dan target dari content studio." },
      { title: "Lead masuk", desc: "Respons iklan diterjemahkan ke lead dan template WA." },
      { title: "Follow-up", desc: "Sales menindaklanjuti lead dari pipeline." },
    ],
    benefits: ["Iklan dan follow-up tersambung", "Lead dari Meta tidak tercecer", "Pipeline terisi dari iklan"],
    related: ["social-media-sora-ai", "iris-meta-ads-analytic", "ctwa", "aplikasi-crm"],
  },

  "iris-meta-ads-analytic": {
    slug: "iris-meta-ads-analytic",
    title: "Meta Ads Analytic by Iris",
    heroTitle: "Pantau performa iklan dengan insight AI",
    heroDesc:
      "Klik, lead terkonfirmasi, konversi, dan tren campaign tampil dalam satu dashboard analitik — membantu tim mengoptimalkan anggaran iklan.",
    status: "Live",
    module: "Iris AI + Social Media",
    flag: "social_media_automation",
    demo: "dashboard",
    demoHash: "dashboardDemo",
    category: "Manajemen Campaign",
    breadcrumbs: ["Produk", "Modul", "Meta Ads Analytic"],
    capabilities: [
      { title: "Klik dan konversi", desc: "Klik, lead terkonfirmasi, dan konversi campaign tampil bersama." },
      { title: "Tren campaign", desc: "Perbandingan performa antar periode dan campaign." },
      { title: "Insight untuk optimasi", desc: "Hasil membantu tim memutuskan alokasi iklan berikutnya." },
    ],
    howItWorks: [
      { title: "Data campaign masuk", desc: "Performa iklan terkumpul dari channel terhubung." },
      { title: "Iris menganalisis", desc: "KPI disajikan dalam dashboard analitik." },
      { title: "Optimasi", desc: "Tim menyesuaikan strategi berdasar hasil." },
    ],
    benefits: ["ROI iklan lebih terlihat", "Keputusan beriklan berbasis data", "Umpan balik cepat ke tim marketing"],
    related: ["social-media-sora-ai", "iris-meta-ads", "ana-ai-analytics", "aplikasi-broadcast-whatsapp"],
  },
