...
window.MOTOVAX_FEATURES = {
  "aplikasi-omnichannel": {
    ...
    heroDesc:
      "Semua chat pelanggan (WhatsApp, Instagram, Facebook) di satu inbox Call Center — ditangani AI 24/7, diambil alih manusia, dan di-handoff ke sales tanpa lead tercecer.",
    status: "Live",
  ...
  "aplikasi-crm": {
    ...
    heroDesc:
      "Kelola peluang dari cold hingga closing dengan follow-up otomatis — satu workspace untuk sales, MR, dan salespeople.",
    status: "Live · flag",
  ...
  "manajemen-deal": {
    ...
    heroDesc:
      "Setiap deal punya stage, customer, minat unit, dan follow-up yang jelas — dari first contact sampai closing.",
    status: "Live · flag",
    module: "M4 · Autopilot CRM",
    flag: "crm_autopilot",
    demo: "crm",
  ...
  "manajemen-kontak": {
    ...
    heroDesc:
      "Database customer terpusat dengan riwayat interaksi, unit diminati, dan konteks penjualan.",
    status: "Live · flag",
    module: "M4 · Autopilot CRM",
    demo: "crm",
    demoHash: "crmDemo",
  ...
  "personalisasi-report-sales": {
    ...
    heroDesc:
      "Laporan operasional untuk management dan sales — performa, channel, konversi, plus email report terjadwal.",
    status: "Live",
  ...
  "sistem-manajemen-tiket": {
    ...
    heroDesc:
      "Ubah chat menjadi tiket: pantau status, eskalasi ke PIC, dan lanjutkan follow-up tanpa kehilangan konteks.",
    status: "Live",
    module: "M3 + M4",
    demo: "omni",
    demoHash: "omniDemo",
  ...
  "automasi-workflow": {
    ...
    heroDesc:
      "Automasi yang berjalan sampai tugas selesai lewat agent AI dan jadwal otomatis, dengan kendali manusia saat dibutuhkan.",
    status: "Live",
  ...
  "aplikasi-broadcast-whatsapp": {
    ...
    heroDesc:
      "Kirim campaign massal ke audiens yang tepat — balasan tetap masuk ke inbox yang sama dan tercatat di CRM.",
    status: "Live · flag",
    module: "M5 + M2",
    demo: "social",
    demoHash: "socialDemo",
  ...
  "core-platform-agentic-ai": {
    ...
    heroDesc: "Fondasi aman untuk semua cabang: atur peran tim, integrasi WhatsApp/Meta, dan aktifkan modul sesuai kebutuhan — dipakai semua agen AI.",
    status: "Live",
  ...
  "omni-jasmine-ai": {
    ...
    heroDesc: "Satu inbox untuk chat WhatsApp, Instagram, dan Facebook dengan AI 24/7. Saat perlu manusia, handoff ke sales tanpa kehilangan konteks.",
    status: "Live",
  ...
  "inventory-falcon-ai": {
    ...
    heroDesc:
      "Falcon mencari unit, mengirim foto, dan merekomendasikan alternatif dari stok live multi-cabang — data tetap akurat untuk sales dan management.",
    status: "Live",
  ...
  "ana-ai-analytics": {
    ...
    heroDesc: "Dashboard operasional, finansial, dan performa sales dealer sesuai peran — revenue, stok, hingga gross profit.",
    status: "Live",
  ...
  "social-media-sora-ai": {
    ...
    title: "Iris AI + Social Media",
    heroTitle: "Buat, jadwalkan, publikasikan, dan ukur konten dari satu studio",
    heroDesc: "Dari stok dealer jadi konten, jadwal posting, dan iklan Meta — dengan wawasan campaign untuk tim marketing.",
    status: "Live · flag",
    module: "Iris AI + Social Media",
    flag: "social_media_automation",
    category: "Manajemen Campaign",
    demo: "social",
    demoHash: "socialDemo",
    breadcrumbs: ["Produk", "Modul", "Iris AI + Social Media"],
    sectionTitle: "Iris mengolah konten, tools studio menjaga publikasinya",
    showcaseTitle: "Kecanggihan Iris dulu, baru tools yang dipakai tim",
    showcaseDesc: "Iris meningkatkan visual dan membantu caption dari data stok. Setelah itu baru studio, scheduler, publish, dan ads yang dipakai marketing.",
